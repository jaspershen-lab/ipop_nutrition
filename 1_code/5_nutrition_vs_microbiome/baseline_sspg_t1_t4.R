...
dir.create("3_data_analysis/nutrition_vs_microbiome_t1_t4/")
dir.create("3_data_analysis/nutrition_vs_microbiome_t1_t4/based_on_sspg/")
setwd("3_data_analysis/nutrition_vs_microbiome_t1_t4/based_on_sspg/")
